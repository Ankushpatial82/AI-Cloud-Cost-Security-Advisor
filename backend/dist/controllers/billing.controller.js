...
exports.downloadInvoicePdf = exports.updateSubscription = exports.getBillingDashboard = void 0;
...
const getBillingDashboard = async (req, res) => {
    try {
        ...
        const subscription = await db_1.default.billingSubscription.findUnique({
...
const updateSubscription = async (req, res) => {
    try {
        ...
        await (0, alert_controller_1.fireAlert)(orgId, "INFO", `Organization subscription updated to ${plan} tier. Thank you for your support!`);
        return res.json({
            success: true,
