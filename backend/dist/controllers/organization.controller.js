...
exports.removeMember = exports.updateMemberRole = exports.addMember = exports.getMembers = exports.createOrganization = exports.getOrganizations = void 0;
...
const getOrganizations = async (req, res) => {
    try {
        ...
        const memberships = await db_1.default.userOrganization.findMany({
            where: { userId },
            include: {
                organization: true,
            },
...
const addMember = async (req, res) => {
    try {
        ...
        if (!user) {
            ...
            const mockPasswordHash = await db_1.default.user.findFirst().then(u => u?.passwordHash || "mock");
        ...
        const existingMember = await db_1.default.userOrganization.findUnique({
            where: {
        ...
        const membership = await db_1.default.userOrganization.create({
            data: {
                userId: user.id,
                organizationId: orgId,
                role: role,
...
const updateMemberRole = async (req, res) => {
    try {
        ...
        const updated = await db_1.default.userOrganization.update({
            where: { id: memberId },
            data: { role },
            include: {
                user: {
...
const removeMember = async (req, res) => {
    try {
        ...
        await db_1.default.userOrganization.delete({ where: { id: memberId } });
        await (0, audit_1.logAuditEvent)({
            userId: req.user?.userId,
            organizationId: orgId,
