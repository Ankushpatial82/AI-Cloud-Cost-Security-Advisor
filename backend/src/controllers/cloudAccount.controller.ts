...
import { queueDiscoveryJob } from "../jobs/discovery.queue";
...
export const addAccount = async (req: Request, res: Response) => {
  try {
    ...
    await queueDiscoveryJob(account.id, orgId, provider);
...
export const validateAccount = async (req: Request, res: Response) => {
  try {
    ...
    await queueDiscoveryJob(account.id, orgId, account.provider);
